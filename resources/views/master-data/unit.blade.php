...
<script>
  $(function () {
    ...
    $(document).on('click', '.btn-tambah', function(){
        ...
        $('#formmodallabel').html('Tambah Unit');
        $('.btn-simpan').val('tambah')
    })

    $(document).on('click', '.btn-edit', function(){
        $('#formmodal').modal('show');
        $('#formmodallabel').html('Edit Unit');
        $('.btn-simpan').val('update')
        var id = $(this).data('id');
        // Send an AJAX request
        $.ajax({
            url: '/unit/'+id, // Replace with your route
            type: 'get',
            success: function (response) {
                // Handle success response
                $('#name_unit').val(response.data.name_unit)
                $('#formmodal').modal('show');
                $('.btn-simpan').val('update')
                $('.btn-simpan').data('id', response.data.id_unit)
            },
