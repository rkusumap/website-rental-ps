...
@section('content')
    <div class="row">
        <div class="col-md-12 grid-margin">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('purchase.store')}}" method="POST" class="form-sample" id="form">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                                                ...
                                                                <td>
                                                                    <select name="product[]" id="firstProduct" class="form-control product-select select2">
                                                                        ...
                                                                        @foreach ($dataProduct as $product)
                                                                            <option data-price="{{$product->hpp_product}}" value="{{$product->id_product}}">{{$product->name_product}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </td>
                                                                <td class="harga">
                                                                    <input type="text" name="price[]" id="" class="form-control priceInput" >
                                                                </td>
                                                                <td class="qty">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="uang_dikeluarkan" id="uang_dikeluarkan" class="form-control rupiahNumber"
                            placeholder="">
    ...
    $(function () {
        ...
        $(document).on('click','.btn-add',function () {
            ...
            <tr>
                ...
                <td class="qty">
                    <input type="number" name="qty[]" class="form-control qtyInput rupiahNumber" value="0">
                </td>
                <td class="total">
                    <input type="text" name="total[]" class="form-control totalInput" readonly>
                </td>
