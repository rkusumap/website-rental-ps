...
@section('content')
    <div class="row">
        <div class="col-md-12 grid-margin">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('purchase.update',$get_data->id_trx)}}" method="POST" class="form-sample" id="form">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select name="" id="firstProduct" class="form-control d-none">
                                    ...
                                    @foreach ($dataProduct as $product)
                                        <option
                                        data-price="{{$product->hpp_product}}" value="{{$product->id_product}}">{{$product->name_product}}</option>
                                    @endforeach
                                </select>
                                                    ...
                                                    <table class="table table-striped" id="keranjang">
                                                        ...
                                                        <tbody id="tbody">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="harga">
                                                                    <input value="{{$trd->hpp_trd}}" type="text" name="price[]" id="" class="form-control priceInput rupiahNumber" >
                                                                </td>
                                                                <td class="qty">
                                                                    <input value="{{$trd->qty_trd}}" type="number" name="qty[]" class="form-control qtyInput rupiahNumber" value="0">
                                                                </td>
                                                                <td class="total">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="id_supplier" id="id_supplier" class="form-control select2">
                                            ...
                                            @foreach ($dataSupplier as $supplier)
                                                <option
                                                {{isSelected($supplier->id_supplier,$get_data->supplier_trx)}}
                                                value="{{$supplier->id_supplier}}">{{$supplier->name_supplier}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 ">Uang Dikeluarkan</label>
                        <div class="col-sm-12">
                            <input value="{{$get_data->amount_given_trx}}" type="text" name="uang_dikeluarkan" id="uang_dikeluarkan" class="form-control rupiahNumber"
                            placeholder="">
                            <div class="invalid-feedback" id="error-uang_dikeluarkan"></div>
                        </div>
                    </div>
...
<script>
    function totalBill(){
        ...
        var uang_dikeluarkan = formatNumberVal($('#uang_dikeluarkan').val());
        ...
        if (jenis_diskon == 'persen') {
            ...
            uang_kembalian = uang_dikeluarkan - grandTotalDenganDiskon;
        }
            ...
            uang_kembalian = uang_dikeluarkan - grandTotal;
        }
    ...
    $(function () {
        ...
        $(document).on('click','.btn-add',function () {
            ...
            <tr>
                ...
                <td class="harga">
                    <input type="text" name="price[]" id="" class="form-control priceInput rupiahNumber" >
                </td>
                <td class="qty">
        ...
        $(document).on('input','#uang_dikeluarkan',function () {
            totalBill()
        })

        $(document).on('input','.priceInput',function () {
            var hpp = formatNumberVal($(this).val());
            var qty = $(this).closest('tr').find('.qty input').val();
            var total  = (hpp*qty).toString();
            $(this).closest('tr').find('.total input').val(funcFormatRupiahNumbers(total));
