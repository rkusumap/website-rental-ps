...
<div class="row">
    <div class="col-md-12 grid-margin">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('module.store')}}" method="POST" class="form-sample" id="form">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="code_module" class="form-control" aria-describedby="code_module">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name_module" class="form-control" aria-describedby="name_module">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="link_module" class="form-control" aria-describedby="name_module">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="icon_module" class="form-control" aria-describedby="icon_module">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="order_module" class="form-control" aria-describedby="order_module">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="action_module" class="form-control smt-tags" aria-describedby="action_module">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description_module" id="description_module" cols="30" rows="10" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
